...
В [отчёте проверки](docs/verification.md) для версии `c2d9dd6` зафиксированы **340 пройденных тестов, 3 E2E-сценария и 99,30% покрытия строк ядра/API**. На исходном каталоге HTTP-ответ занимал **2,2–51,0 мс** в короткой локальной проверке; ориентир ТЗ — до 10 секунд. Эти измерения относятся к указанному окружению и не являются гарантией под нагрузкой.
